  ...
  <office:body>
    <office:spreadsheet>
      <table:table table:name="List">
        ...
        <table:table-row table:style-name="rdef"><table:covered-table-cell table:number-columns-repeated="1"/><table:table-cell office:value-type="string" table:number-rows-spanned="1" table:number-columns-spanned="3"><text:p>three</text:p></table:table-cell><table:covered-table-cell table:number-columns-repeated="2" /><table:table-cell office:value-type="string"><text:p>last</text:p></table:table-cell></table:table-row>
        <table:table-row table:style-name="rdef"><table:covered-table-cell table:number-columns-repeated="1"/><table:covered-table-cell/></table:table-row>
